-- ==========================================================
-- FinanzasU - Full Database Setup (Supabase)
...
-- Compatibilidad por si tablas fueron creadas por scripts antiguos
...
create index if not exists idx_transacciones_usuario_fecha on public.transacciones(usuario_id, fecha);
create index if not exists idx_presupuestos_usuario on public.presupuestos(usuario_id);
create index if not exists idx_presupuestos_periodo on public.presupuestos(usuario_id, mes, anio);

-- Unicidad robusta de categorias
...
-- ----------------------------------------------------------
-- Funciones de soporte y triggers de integridad
-- ----------------------------------------------------------
